...
const LoginPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (user) {
            console.log('************** user ************\n', user);
            dispatch({ type: 'add', payload: { email: user, firstName: '', lastName: ''}});
        }
        // router.push('/')
    };
    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <form className="bg-white shadow-xl shadow-slate-100 rounded px-8 pt-6 pb-8 mb-4 w-1/3" onSubmit={handleSubmit}>
                <div className="mb-4">
